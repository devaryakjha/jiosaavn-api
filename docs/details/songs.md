...
```bash
https://saavn.aryak.dev/songs?link=https://www.jiosaavn.com/song/thunderclouds/RT8zcBh9eUc
```

CURL

```bash
curl -X GET 'https://saavn.aryak.dev/songs?link=https://www.jiosaavn.com/song/thunderclouds/RT8zcBh9eUc' \
...
```bash
https://saavn.aryak.dev/songs?id=5WXAlMNt
```

CURL

```bash
curl -X GET 'https://saavn.aryak.dev/songs?id=5WXAlMNt' \
 -H 'content-type: application/json'
```
...
```bash
https://saavn.aryak.dev/songs?id=5WXAlMNt,csaEsVWV
...
```bash
curl -X GET 'https://saavn.aryak.dev/songs?id=5WXAlMNt,csaEsVWV
' \
 -H 'content-type: application/json'
```
